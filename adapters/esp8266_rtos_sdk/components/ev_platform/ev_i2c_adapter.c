...
#endif
#define EV_ESP8266_I2C_TARGET_HALF_PERIOD_US \
    ((500000U + EV_ESP8266_I2C_TARGET_SPEED_HZ - 1U) / EV_ESP8266_I2C_TARGET_SPEED_HZ)
...
#error "ESP8266 I2C 400 kHz evidence-gated profile must use a conservative 2 us nominal half-period until measured"
#endif
