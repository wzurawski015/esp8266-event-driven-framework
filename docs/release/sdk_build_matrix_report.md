...
| `atnel_air_esp_motherboard_i2c_hil` | `hil_sdk` | `adapters/esp8266_rtos_sdk/targets/atnel_air_esp_motherboard_i2c_hil` | PASS | `logs/sdk/atnel_air_esp_motherboard_i2c_hil/build.log` |  |
| `atnel_air_esp_motherboard_onewire_hil` | `hil_sdk` | `adapters/esp8266_rtos_sdk/targets/atnel_air_esp_motherboard_onewire_hil` | PASS | `logs/sdk/atnel_air_esp_motherboard_onewire_hil/build.log` |  |
| `atnel_air_esp_motherboard_wifi_hil` | `hil_sdk` | `adapters/esp8266_rtos_sdk/targets/atnel_air_esp_motherboard_wifi_hil` | PASS | `logs/sdk/atnel_air_esp_motherboard_wifi_hil/build.log` |  |
