...
The log port pending hook is optional. When present, quiescence reports pending log records and can block sleep according to `log_policy`. When absent, pending log records are treated as zero.
